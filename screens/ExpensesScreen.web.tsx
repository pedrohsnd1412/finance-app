    ...
    return (
        <div className="flex-1 overflow-y-auto p-8 bg-[#0d0d12] text-white font-sans selection:bg-indigo-500/30">
            <div className="flex justify-between items-center mb-8">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">{t('home.transactions')}</h1>
                    <p className="text-gray-500 mt-1">{t('home.transactionsSubtitle')}</p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
                ...
                />
                <StatCard
                    title={t('home.stats.totalExpenses')}
                    ...
                    chartData={[
                        ...
                        { month: 'Feb', value: 30 },
                        { month: 'Mar', value: 50 },
                        { month: 'Apr', value: 70, active: true, label: summary.expenseTotal.toFixed(0) },
                    ]}
                />
                <GlassCard className="flex flex-col justify-between">
                    <div className="flex justify-between items-center">
                        <span className="text-xs text-gray-400 font-medium uppercase tracking-wider">{t('home.topCategory')}</span>
                        <MoreVertical size={16} className="text-gray-500" />
                    </div>
                    <div>
                        <h3 className="text-2xl font-bold mt-2">Shopping</h3>
                        <p className="text-sm text-gray-500">25% of total expenses</p>
                    </div>
            ...
            <GlassCard className="p-0 overflow-hidden">
                <div className="p-8 pb-0">
                    <TransactionList transactions={transactions} title={t('home.recentTransactions')} />
                </div>
            </GlassCard>
        </div>
    );
